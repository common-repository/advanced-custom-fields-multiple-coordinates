...
<div>
    ...
    <input type="submit" class="location_multiple_coordinates_add button button-primary" value="Add coordinate"></input>
	...
	<input type="submit" class="location_multiple_coordinates_values_button button" value="Copy" />
    <input style="display:none" type="text" class="location_multiple_coordinates_values" id="location_multiple_coordinates_values_<?=esc_attr($uid)?>" name="<?=esc_attr($field['name'])?>" value="<?=esc_attr($values)?>">
