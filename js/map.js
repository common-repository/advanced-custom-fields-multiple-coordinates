...
jQuery(function($) {
    ...
    var MultipleCoordinatesMap = function(map_elm) {
		...
		this.values_button = this.container_elm.find('.location_multiple_coordinates_values_button');
    ...
    var asMultipleCoordinatesMap = (function() {
        ...
        var RegisterHandlers = function() {
			...
			// add click event on the copy values button
            self.values_button.click(function(e) {
				e.preventDefault();
				// set remove mode
				$(this).toggleClass("button-primary");
				//self.UpdateUI();
				self.values_elm.toggle().select();
			});
